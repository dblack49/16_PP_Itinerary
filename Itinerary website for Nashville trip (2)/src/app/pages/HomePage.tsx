    ...
    <div className="min-h-screen bg-gradient-to-br from-pink-50 via-white to-green-50">
      ...
      <div className="max-w-6xl mx-auto px-6 py-12">
        ...
        <div className="text-center mb-12">
          <h2 className="text-4xl mb-4 bg-gradient-to-r from-pink-600 to-green-600 bg-clip-text text-transparent" 
          ...
          <div className="grid md:grid-cols-3 gap-4 mb-8">
            <Link 
              to="/whos-ready"
              className="inline-flex items-center justify-center gap-3 bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white px-6 py-4 rounded-full shadow-xl hover:shadow-2xl transition-all text-lg"
              style={{ fontFamily: "'Playfair Display', serif" }}
            >
            ...
            <Link 
              to="/split-payment"
              className="inline-flex items-center justify-center gap-3 bg-gradient-to-r from-purple-500 to-purple-600 hover:from-purple-600 hover:to-purple-700 text-white px-6 py-4 rounded-full shadow-xl hover:shadow-2xl transition-all text-lg"
              style={{ fontFamily: "'Playfair Display', serif" }}
            >
        ...
        <div className="bg-gradient-to-br from-pink-100 to-green-100 rounded-3xl p-8 shadow-xl border-4 border-yellow-400 mb-12">
          ...
          <div className="bg-white rounded-2xl p-6 space-y-4">
            ...
            <div>
              ...
              <p className="text-gray-700">$50.00 per Pearl - Get your welcome bag on arrival!</p>
            </div>
          </div>
        </div>
        ...
        {/* Trip Tips */}
        <div className="bg-white rounded-3xl p-8 shadow-xl border-4 border-green-300 mb-12">
          <h3 className="text-3xl text-center mb-6 text-green-800" style={{ fontFamily: "'Rye', serif" }}>
            Nashville Tips
          </h3>
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-gradient-to-br from-pink-50 to-pink-100 rounded-xl p-6">
              <h4 className="text-xl mb-3 text-pink-800" style={{ fontFamily: "'Playfair Display', serif" }}>
                🌶️ Hot Chicken Levels
              </h4>
              <p className="text-gray-700">
                Start with "mild" or "medium" - Nashville hot chicken is no joke! Work your way up if you dare.
              </p>
            </div>
            <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-xl p-6">
              <h4 className="text-xl mb-3 text-green-800" style={{ fontFamily: "'Playfair Display', serif" }}>
                🎵 Live Music
              </h4>
              <p className="text-gray-700">
                Most bars on Broadway have no cover charge! Just tip your bartenders and enjoy the music.
              </p>
            </div>
            <div className="bg-gradient-to-br from-pink-50 to-pink-100 rounded-xl p-6">
              <h4 className="text-xl mb-3 text-pink-800" style={{ fontFamily: "'Playfair Display', serif" }}>
              ...
              <p className="text-gray-700">
                Cowgirl boots are a must! But also bring comfy shoes - we'll be doing lots of walking.
              </p>
            </div>
            <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-xl p-6">
              <h4 className="text-xl mb-3 text-green-800" style={{ fontFamily: "'Playfair Display', serif" }}>
              ...
              <p className="text-gray-700">
                Don't forget to pack your letters! We're representing our beautiful sorority all weekend.
              </p>
            </div>
          </div>
        </div>
